...
const RightCard = ({ imgSrc, name = "Satisfied" }) => {
  return (
    <div
      className={`h-full relative    w-3/8 rounded-4xl px-7 flex flex-col justify-between`}
    >
      <img
        src={imgSrc}
        className="w-full h-full absolute inset-0 -z-10 object-cover opacity-60 rounded-4xl"
        alt=""
      />
